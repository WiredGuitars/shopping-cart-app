...
export default function About() {
  return (
    <div className={Styles.mainContainer}>
      ...
      <div className={Styles.mainDescrip}>In actuality, this web-app is meant to demonstrate
      WiredGuitars@github's proficiency using React. Concepts such as: writing tests, fetching and receiving data,
